...
class NVAveragerProgram_johns(QickRegisterManagerMixin, QickProgram):
    """
    ...
    def acquire(self, reads_per_rep=1, load_pulses=True, start_src="internal", progress=False, debug=False, zero = 0):
        """
        ...
        zero = zero*self.cfg.readout_integration_treg
    ...
    def ttl_readout(self):
        ...
        3. turn on laser adc off at time self.cfg.laser_readout_offsetz+ self.cfg.readout_integration
    ...
    def init_save(self, config, data, folder_path, folder_name = None, separate_dates = True):
        ...
        pickle.dump(config, open(folder_path + '/Config.pkl', 'wb'))
